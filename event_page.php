<?php
    ...
    $sql ="SELECT * FROM event_list WHERE status='approved'";
...
<body>
	...
	<div class="menu">
		<div class="page_name">Events</div>
    ...
    <div class="event_card">
		...
		<div class="middle">
			...
			<a href="event_show.php?id=<?php echo $row['id']; ?>"><button class="register-btn">Register</button></a>
		</div>
	</div>
    <?php
        }
